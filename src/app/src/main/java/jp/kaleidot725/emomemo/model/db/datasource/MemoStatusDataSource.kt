...
class MemoStatusDataSource(private val repository: MemoStatusRepository) : PageKeyedDataSource<Int, MemoStatusView>() {
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, MemoStatusView>) {
        ...
        // ページに表示するデータを取得する
        val items = repository.getPage(page, perPage)
